...
// ( звітси і назва: callback – функція зворотнього виклику )
// Я так розумію: колбек це функція в аргументі, яка виконається коли виконується зовнішня, наприклат тайм-аут
...
// Не всі колбекі асінхронні, наприклад методи масивів виконують колбек одразу. 
// Ці колбекі не очікують ніяких дій, а виконуються одразу.
...
// Нижче ми очікуємо виконання промісів з об'єкта в результат, оскільки вони були запущені одночасно, блокуючи потік, 
// і виконуються одночасно.
...
console.log('Починаємо відлик');
setTimeout(fn, 2000);
console.log('Таймер запущений, чекаємо...');